...
game = hlt.Game("NR7-Attacker-v27")
...
while True:
    ...
    for task in task_priority:
        ...
        for ship in AllFreeShips:
            ...
            # elif task == "resume_steal" and ship.assigned_task and ("steal" in ship.assigned_task):
            ...
            #             ship.issueCommand(ship.navigate(ship.steal(target_ship, number_of_players = cnp),game_map), "re-steal", target_ship.id)
